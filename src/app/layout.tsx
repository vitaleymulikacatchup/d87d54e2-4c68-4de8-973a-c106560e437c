...
export const metadata: Metadata = {
  title: "F1 Elite - Premium Formula 1 Racing Machines",
  description: "Explore the pinnacle of Formula 1 automotive engineering. Experience high-performance racing machines used by championship teams worldwide.",
  keywords: "Formula 1, F1 cars, racing machines, motorsport, championship racing",
  metadataBase: new URL("https://f1elite.com"),
  alternates: {
    canonical: "https://f1elite.com"
  },
  openGraph: {
    title: "F1 Elite - Premium Formula 1 Racing Machines",
    description: "Discover the cutting-edge performance machines that dominate Formula 1 racing competition.",
    type: "website",
    siteName: "F1 Elite",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1766057949801-x5uf0ox9.jpg",
      alt: "F1 Elite Premium Racing Machine"
    }]
  },
  twitter: {
    ...
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1766057949801-x5uf0ox9.jpg"]
  },
  robots: {
    index: true,
    follow: true
